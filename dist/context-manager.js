 ...
 */
export async function getFileContent({ octokit, owner, repo, path, ref = 'HEAD', maxLines = 500 }) {
    try {
 ...
 */
export function optimizeContext({ diff, fileContents, modelMaxTokens = 200000, safetyFactor = 0.9 }) {
